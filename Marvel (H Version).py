...
def gui(cursor):
    ...
    while(response == "Y"):
        ...
        print("7.Show the average release year and the number of characters being part of each side")
        print("8.Show the name, year, artist and writer of the comic book wanted")
        print("9.Show how many movies were released for each year where at least a movie was released")
        print("10.Show the title, year and director of the movie id given")
        print("11.Show the movie(s) on a specific year wanted")
        ...
        # We get the sides, the average release year and how many characters of each side there are
            ...
            print("1. Symbiote Spider-Man Vol 1 #5\
                   ...
                   \n9. Iron Man Vol 4 #4\
                   \n10. Avengers Vol 1 #1")
            answer = str(input("Enter the id for the comic book wanted: "))
            cursor.execute("SELECT name, year, writer, artist FROM comic_books WHERE id = " + answer)
            for i in cursor:
                print(i)
            response = input("To go back to main menu, press Y: ")
            print("")
            ...
            cursor.execute("SELECT release_year, COUNT(release_year)FROM MOVIES GROUP BY release_year ")
            for i in cursor:
                print(i)
            response = input("To go back to main menu, press Y: ")
            print("")
            ...
            print("1. Eternals\
                 ...
                 \n7. Shang-Shi and The Legends of the Ten Rings	\
                 \n8. Ant-Man	\
                 \n9. Captain Marvel	\
                 \n10. Doctor Strange	\
                 \n11. The Avengers")
            answer = str(input("Enter the id of the movie wanted: "))
            cursor.execute("SELECT title, director, release_year FROM movies WHERE id = " + answer)
            for i in cursor:
                print(i)
            response = input("To go back to main menu, press Y: ")
            print("")
            ...
            answer = str(input("Enter the year wanted: "))
            cursor.execute("SELECT title FROM movies WHERE release_year = " + answer)
            for i in cursor:
                print(i)
            response = input("To go back to main menu, press Y: ")
            print("")
